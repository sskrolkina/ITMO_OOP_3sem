...
{
    private const int VaclasWeight = 50;
    ...
    public Vaclas(IPhotonicDeflector? deflector)
    {
        _pulseEngine = new EPulseEngine();
        _jumpEngine = new Gamma();
    ...
    public override double PulseBoost()
    {
        ...
        return _pulseEngine.Boost * VaclasWeight;
    }
    ...
    public override double JumpBoost()
    {
        ...
        return _jumpEngine.Boost * VaclasWeight;
    }
